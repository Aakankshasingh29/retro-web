...
<div class="container mx-auto bg-indigo-200 p-4 rounded-xl">
  <h1 class="text-2xl font-bold mb-2">Become a Creator</h1>
  <p>At Retro Fusion,all our team members are known as Creators and we empower them to innovate, champion ground-breaking ideas, and bring courage – and fun – to work every day.</p>
  ...
  <div className="container mx-md bg-purple-700 p-4 rounded-md">
    ...
    <div className="flex bg-purple-300 rounded-lg shadow dark:bg-gray-800 ">
    <div class="container px-5 py-10 mx-auto">
        ...
        <p class="max-w-xl mx-auto my-6 text-center text-gray-800 dark:text-gray-300">
